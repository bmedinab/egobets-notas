...
\begin{itemize}
	...
	\item \textbf{Perfil de riesgo.} Despendiendo de la encuesta realizada por usuario se tiene su aversión al riesgo.
...
\begin{itemize}
	...
	\begin{itemize}
		\item Pendiente: se ha iniciado la transacción para la compra de jornadas, sin embargo aún no ha concluido.
