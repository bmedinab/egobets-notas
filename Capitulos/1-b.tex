...
El mercado de estudio de este trabajo es el de los ``bookies'' o corredores de apuestas. Sin embargo, bajo las condiciones adecuadas la asesoría de apuestas podría ayudar a los jugadores en el mercado parimutual. Por ejemplo, en una apuesta entre compañeros del trabajo es fácil conseguir la información del mercado y calcular los pagos que se harán a cada uno de los resultados. Por lo que uno de los usuarios podría usar esta información y la información del mercado de los momios de las casas de apuestas y simplemente cerciorarse de que su apuesta asegure una mayor cantidad que la que garantizaría el mercado.

La eficiencia de estos mercados no es un tema que se profundize en esta tesis. Sin embargo, es importante mencionar que el mercado de los momios de los bookies ha sido cuestionado en eficiencia, se pueden revisar a Sauer \cite{sauer1998economics} y Williams \cite{williams1999information} donde se explica más acerca de anomalías como el ``sesgo favorite-longshot'' que implica que las apuestas a los favoritos generan un mayor retorno que las ``apuestas a longshots'' (apuestas arriesgadas). Incluso se han realizado varios estudios proponiendo un nuevo mercado de tipo ``doble subasta'' que consiste en tener compradores y vendedores fijando los precios, cuando dos de ellos coinciden, se lleva acabo la transacción. Referirse a Ozgit\cite{ozgit2005posted}.
