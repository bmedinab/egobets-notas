...
% Capítulo 1 y dos tal como están
% Capítulo  3: Egobets: Matemáticas
% Capítulo  4: Egobets: Sistema
% 4.1 Descripción  de egobets (componentes y funcionalidad  a alto nivel)
% 4.2 Descripción  de Principios de diseño (¿por qué  hacerlo así?)
% 4.3 Diseño de  bases de datos (empieza indicando que al ser un MVC web está  orientado a diseñarse desde la base de datos hacia la pantalla)
% 4.4 Elección de tecnología
% 5. Conclusiones.
