...
El ecosistema de Egobets consiste en cuatro piezas de software Ver la figura~\ref{Fig:Sistemas}. En este capítulo se describirán los sistemas que el usuario adminstrativo debe usar para poder a echar a andar toda la maquinaria detrás del sistema.
