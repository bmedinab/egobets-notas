...
\begin{figure}[!htb]\centering
   \begin {minipage}{0.49\textwidth}
     ...
     \caption{Cerrar Sesión}\label{Fig:Logout}
   \end{minipage}
\end{figure}
...
\begin{figure}[!htb]\centering
   \begin {minipage}{0.8\textwidth}
     ...
     \caption[Caption for LOF]{Subir archivos y procesarlos\footnotemark}
	 \label{Fig:ingesta}
   \end{minipage}
\end{figure}
...
\begin{figure}[!htb]\centering
   \begin {minipage}{1\textwidth}
     ...
     \caption[Caption for LOF]{Partidos procesados por el sistema}
	 \label{Fig:partidos}
   \end{minipage}
\end{figure}
...
\begin{figure}[!htb]\centering
   \begin {minipage}{1\textwidth}
     ...
     \caption[Caption for LOF]{Actualizando datos de los equipos}
	 \label{Fig:equipos}
   \end{minipage}
\end{figure}
...
\begin{figure}[!htb]\centering
   \begin {minipage}{0.64\textwidth}
     ...
     \caption[Caption for LOF]{Actualizando marcadores de la liga italiana}
	 \label{Fig:equipos}
   \end{minipage}
\end{figure}
...
\begin{figure}[!htb]\centering
   \begin {minipage}{1\textwidth}
     ...
     \caption[Caption for LOF]{Listado de Usuarios}
	 \label{Fig:usuarios}
   \end{minipage}
\end{figure}
...
\begin{figure}[!htb]\centering
   \begin {minipage}{1\textwidth}
     ...
     \caption[Caption for LOF]{Vista del detalle de usuario}
...
\begin{figure}[!htb]\centering
   \begin {minipage}{0.5\textwidth}
     ...
     \caption[Caption for LOF]{Confirmar la eliminación de un usuario\footnotemark}
...
\begin{figure}[!htb]\centering
   \begin {minipage}{1\textwidth}
     ...
     \caption[Caption for LOF]{Listado con los últimos pagos realizados}
...
\begin{figure}[!htb]\centering
   \begin {minipage}{0.4\textwidth}
     ...
     \caption[Caption for LOF]{Ganancias y pérdidas de los usuarios}
...
\begin{figure}[!htb]\centering
   \begin {minipage}{0.4\textwidth}
     ...
     \caption[Caption for LOF]{Usuarios recién inscritos}
...
\begin{figure}[!htb]\centering
   \begin {minipage}{1\textwidth}
     ...
     \caption[Caption for LOF]{Datos estadísticos de los usuarios}
...
\begin{figure}[!htb]\centering
   \begin {minipage}{0.5\textwidth}
     ...
     \caption[Caption for LOF]{Pagos más recientes}
...
\begin{figure}[!htb]\centering
   \begin {minipage}{0.5\textwidth}
     ...
     \caption[Caption for LOF]{Partidos acertados}
...
\begin{figure}[!htb]\centering
   \begin {minipage}{0.8\textwidth}
     ...
     \caption[Caption for LOF]{Comunicación con los usuarios}
	 \label{Fig:correos}
   \end{minipage}
\end{figure}
